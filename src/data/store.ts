...
function mapRow(
  ...
  return {
    ...
    purposeCode: (row.purpose_code as RBIPurposeCode) || 'S0014',
    tdsDeducted: row.tds_deducted ?? false,
...
function seedDemoIfEmpty() {
  ...
  type DemoSeed = {
    ...
    purposeCode: 'S0014'; tdsDeducted: boolean; tdsAmountINR: number; tdsReference: string;
